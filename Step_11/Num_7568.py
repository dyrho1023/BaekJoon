...
# weight = []
# height = []
# indexStudent = [[0 for i in range(in1)] for j in range(in1)]
#
# for i in range(in1):
#     student.append(list(map(int, input().split())))
#     weight.append(student[i][0])
#     height.append(student[i][1])
#
# weight.sort()
# height.sort()
#
# for i in range(in1):
#     indexStudent[weight.index(student[i][0])][height.index(student[i][1])] = \
#         indexStudent[weight.index(student[i][0])][height.index(student[i][1])] + 1
#
# count = 0
# for i in range(in1):
#     count = 0
#     for j in range(weight.index(student[i][0])+1, in1):
#         for k in range(height.index(student[i][1])+1, in1):
#             count = count + indexStudent[j][k]
#     print(count+1)